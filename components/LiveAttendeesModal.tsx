        ...
        >
          ...
          >
            ...
            >
              ...
              {/* メインカードコンテナ */}
              <div
                className="bg-white rounded-2xl shadow-xl overflow-hidden relative min-h-[300px] max-h-[550px] sm:max-h-[400px]"
                style={{
                  paddingTop: '1.5rem',
                          ...
                          >
                            ...
                            >
                              <Avatar className="h-full w-full">
                                ...
                                <AvatarFallback className="bg-gray-400 text-white text-4xl">
                                ...
                                {currentAttendee.galleryImages.map((image: string, index: number) => (
                                  ...
                                  >
                                    <img
                                      src={image}
                                      alt={`Gallery ${index + 1}`}
                                      className="w-[70px] h-[70px] object-cover rounded-lg border border-gray-200"
                                      loading="lazy"
                                      decoding="async"
                                    />
                                  </motion.div>
